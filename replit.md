...
## Changelog
- June 26, 2025: Invoice Print System - completely rebuilt invoice print page with simplified data fetching, proper error handling, minimal layout optimized for printing, and removed modal dependencies for direct new tab printing functionality
