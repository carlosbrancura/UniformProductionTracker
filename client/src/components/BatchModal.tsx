                ...
                {batch.workshopId && (
                  <div className="flex justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {workshops.find(w => w.id === batch.workshopId)?.phone && (
                        <a 
                          href={`https://wa.me/55${workshops.find(w => w.id === batch.workshopId)?.phone?.replace(/\D/g, '') || ''}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-green-600 hover:text-green-800"
                          title={`WhatsApp ${workshops.find(w => w.id === batch.workshopId)?.name || 'Oficina'}`}
                        >
